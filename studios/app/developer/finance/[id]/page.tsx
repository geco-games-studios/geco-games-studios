...
export default function DeveloperAccountDetailPage() {
  ...
  const fetchAccount = async () => {
    try {
      ...
      setError("Unable to load account. Ensure you're authenticated and try again.")
    } finally {
      setIsLoading(false)
    }
  }
  ...
  return (
    <main className="container mx-auto p-6">
      <h2 className="text-2xl font-semibold mb-4">Developer Account {account.id}</h2>
